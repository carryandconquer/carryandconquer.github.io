...
('news', 'J&J Resumes Varipulse Rollout', 'US market expansion continues', 'Rocket', 'primary', 'Product Launch', 'Reuters', true, 3, 1),
('news', 'Peerbridge Launches Wearable ECG', 'New Peerbridge Cor® device announced', 'Zap', 'accent', 'Innovation', 'PR Newswire', true, 4, 1),
('news', 'New AFib Detection Technology', '95% accuracy wearable device', 'Target', 'secondary', 'Research', 'arXiv', true, 5, 1);
