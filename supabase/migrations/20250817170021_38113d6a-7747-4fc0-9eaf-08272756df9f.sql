...
-- RLS Policies
-- Public read where applicable, authenticated write
-- Lookup tables: public can read, authenticated can write
create policy if not exists "Public can read regions" on public.snapshot_geographic_regions for select using (true);
create policy if not exists "Auth can write regions" on public.snapshot_geographic_regions for all to authenticated using (true) with check (true);

create policy if not exists "Public can read countries" on public.snapshot_countries for select using (true);
create policy if not exists "Auth can write countries" on public.snapshot_countries for all to authenticated using (true) with check (true);

create policy if not exists "Public can read cities" on public.snapshot_cities for select using (true);
create policy if not exists "Auth can write cities" on public.snapshot_cities for all to authenticated using (true) with check (true);

create policy if not exists "Public can read sectors" on public.snapshot_sectors for select using (true);
create policy if not exists "Auth can write sectors" on public.snapshot_sectors for all to authenticated using (true) with check (true);

create policy if not exists "Public can read sub sectors" on public.snapshot_sub_sectors for select using (true);
create policy if not exists "Auth can write sub sectors" on public.snapshot_sub_sectors for all to authenticated using (true) with check (true);

create policy if not exists "Public can read categories" on public.categories for select using (true);
create policy if not exists "Auth can write categories" on public.categories for all to authenticated using (true) with check (true);

-- Articles: public can read published; auth can write
create policy if not exists "Public can read published articles" on public.articles for select using (published = true);
create policy if not exists "Auth can write articles" on public.articles for all to authenticated using (true) with check (true);

-- Deals: public can read published; auth can write
create policy if not exists "Public can read published deals" on public.deals for select using (published = true);
create policy if not exists "Auth can write deals" on public.deals for all to authenticated using (true) with check (true);

-- Events: public can read published; auth can write
create policy if not exists "Public can read published events" on public.events for select using (published = true);
create policy if not exists "Auth can write events" on public.events for all to authenticated using (true) with check (true);

-- Market metrics: public read all; auth write
create policy if not exists "Public can read market metrics" on public.snapshot_market_metrics for select using (true);
create policy if not exists "Auth can write market metrics" on public.snapshot_market_metrics for all to authenticated using (true) with check (true);

-- Market comparisons: public read published; auth write
create policy if not exists "Public can read published market comparisons" on public.snapshot_market_comparisons for select using (published = true);
create policy if not exists "Auth can write market comparisons" on public.snapshot_market_comparisons for all to authenticated using (true) with check (true);

-- Sector intelligence: public read published; auth write
create policy if not exists "Public can read published sector intelligence" on public.snapshot_sector_intelligence for select using (published = true);
create policy if not exists "Auth can write sector intelligence" on public.snapshot_sector_intelligence for all to authenticated using (true) with check (true);

-- Trending people: public read published; auth write
create policy if not exists "Public can read published trending people" on public.snapshot_trending_people for select using (published = true);
create policy if not exists "Auth can write trending people" on public.snapshot_trending_people for all to authenticated using (true) with check (true);

-- Trending projects: public read published; auth write
create policy if not exists "Public can read published trending projects" on public.snapshot_trending_projects for select using (published = true);
create policy if not exists "Auth can write trending projects" on public.snapshot_trending_projects for all to authenticated using (true) with check (true);
