...
export function ExitItem({ metric }: ExitItemProps) {
  const IconComponent = getIconComponent(metric.icon_name || 'Trophy')
  const { textColor, bgColor } = getColorClasses(metric.color_scheme || 'success')
